...
namespace URMT.Template.Templates {
    ...
    public static class TemplateManager {
        ...
        static TemplateManager() {
            ModuleManager.OnAllModulesLoaded += OnAllModulesLoaded;
        }

        private static void OnAllModulesLoaded() {
        ...
        public static void ApplyTemplateToFiles(string sourcePath, string destinationPath, string handlerKey, params object[] args) {
            if(sourcePath != destinationPath) FileSystemUtils.CopyDirectory(sourcePath, destinationPath);
